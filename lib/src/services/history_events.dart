...
final historyEventsProvider = StateProvider<List<HistoryEvent>>(
  (ref) => const [
    HistoryEvent(
        yearAfterBC: -3000, title: 'Earliest known writing system, Sumerians'),
    ...
    HistoryEvent(
        yearAfterBC: 1492, title: 'Christopher Columbus reaches the Americas'),
    HistoryEvent(yearAfterBC: 1517, title: "Martin Luther's 95 Theses"),
    HistoryEvent(
        yearAfterBC: 1582, title: 'Introduction of the Gregorian calendar'),
    HistoryEvent(
        yearAfterBC: 1607,
        title:
            'Establishment of Jamestown, the first English colony in America'),
    HistoryEvent(
        yearAfterBC: 1776,
    ...
    HistoryEvent(
        yearAfterBC: 1947, title: 'Independence and partition of India'),
    HistoryEvent(
        yearAfterBC: 1959, title: 'Cuban Revolution led by Fidel Castro'),
